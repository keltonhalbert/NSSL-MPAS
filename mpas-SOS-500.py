...
def make_plot(filename, count):
    ...
    ax.text(0.75, 0.5, "MPAS 250hPa Wind and Height\n" + time, transform=ax.transAxes,
             fontsize=14, verticalalignment='top', horizontalalignment="center", bbox=props,
             weight="bold")

    ax.text(0.5, 0.5, "MPAS 250hPa Wind and Height\n" + time, transform=ax.transAxes,
             fontsize=14, verticalalignment='top', horizontalalignment="center", bbox=props,
             weight="bold")

    ax.text(0.25, 0.5, "MPAS 250hPa Wind and Height\n" + time, transform=ax.transAxes,
             fontsize=14, verticalalignment='top', horizontalalignment="center", bbox=props,
             weight="bold")
    ...
    plt.savefig("/glade/u/home/khalbert/scripts/SOS-250_wind" + str(count).zfill(3) + ".png", pad_inches=0, bbox_inches="tight", dpi=75)
    plt.clf()
    plt.close(fig)
