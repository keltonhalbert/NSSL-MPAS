...
def make_plot(filename, count):
    ...
    cm = ax.tricontourf(triang, cape, levels=np.arange(10,32,2), cmap=plt.get_cmap("gist_earth_r"), extend="max")
    ...
    plt.savefig("/glade/u/home/khalbert/scripts/sfc" + str(count).zfill(3) + ".png", pad_inches=0.1, bbox_inches="tight")
    plt.clf()
    plt.close(fig)
...
if __name__ == "__main__":
    ...
    os.system("convert " + os.path.dirname(__file__) + "/sfc* " + os.path.dirname(__file__) + "/mpas-sfc.gif")
    os.system("scp " + os.path.dirname(__file__) + "/mpas-sfc.gif arctic:/var/www/html")
