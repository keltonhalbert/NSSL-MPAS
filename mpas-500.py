...
def make_plot(filename, count):
    ...
    plt.savefig("/glade/u/home/khalbert/scripts/500_wind" + str(count).zfill(3) + ".png", pad_inches=0.1, bbox_inches="tight")
    plt.clf()
    plt.close(fig)
...
if __name__ == "__main__":
    ...
    os.system("convert " + os.path.dirname(__file__) + "/500_wind* " + os.path.dirname(__file__) + "/mpas-500hPa.gif")
    os.system("scp " + os.path.dirname(__file__) + "/mpas-500hPa.gif arctic:/var/www/html")
