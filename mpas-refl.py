...
def make_plot(filename, count):
    ...
    plt.savefig("/glade/u/home/khalbert/scripts/refl" + str(count).zfill(3) + ".png", pad_inches=0.1, bbox_inches="tight")
    plt.clf()
    plt.close(fig)
...
if __name__ == "__main__":
    ...
    os.system("convert " + os.path.dirname(__file__) + "/refl* " + os.path.dirname(__file__) + "/mpas-refl.gif")
    os.system("scp " + os.path.dirname(__file__) + "/mpas-refl.gif arctic:/var/www/html")
